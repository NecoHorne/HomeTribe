...
public class EmailLoginActivity extends AppCompatActivity implements MyDialogCloseListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        emailLoginSetup();
        mProgressBar = (ProgressBar) findViewById(R.id.email_progressbar);
        mLoggedInIntent = new Intent( EmailLoginActivity.this, MainActivity.class );
        setupFirebaseAuth();
    }
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    if (user.isEmailVerified()) {
                        Toast.makeText(EmailLoginActivity.this, "Logged In", Toast.LENGTH_LONG).show();
    ...
    private void createNewAccount() {
        Intent newAccountIntent = new Intent(EmailLoginActivity.this, RegisterNewAccount.class);
    ...
    private void emailLogin() {
        ...
        if (!isEmpty(email.getText().toString())
            ...
            Toast.makeText( EmailLoginActivity.this, "Please fill in all fields", Toast.LENGTH_SHORT).show();
        }
